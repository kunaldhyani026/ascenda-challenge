...
To write the application you can use any language. It should work as a web server. Please push to github and please make sure the code is correct and it has adequate information to run the application.
