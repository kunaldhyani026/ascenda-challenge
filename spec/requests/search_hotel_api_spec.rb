    ...
    context 'Valid Payload' do
      ...
      it 'should return hotel fetched using hotel id' do
        ...
        expect(body).to eq([{"id"=>"iJhz",
                             ...
                             "location"=>{"address"=>"8 Sentosa Gateway, Beach Villas 098269", "city"=>"Singapore", "country"=>"SG", "lat"=>1.264751, "lng"=>103.824006},
                             "description"=>
      ...
      it 'should return hotels fetched using multiple hotel ids' do
        ...
        expect(body).to eq([{"id"=>"iJhz",
                            ...
                            {"id"=>"SjyX",
                             ...
                             "location"=>{"address"=>"1 Nanson Road 238909", "city"=>"Singapore", "country"=>"SG", "lat"=>nil, "lng"=>nil},
                             "description"=>
